...
mainMenu::mainMenu()
    : backgroundSprite(ResourceManager::getTexture(TextureType::MenuBackground)),
      startButtonSprite(ResourceManager::getTexture(TextureType::MenuStartButton)),
      settingsButtonSprite(ResourceManager::getTexture(TextureType::MenuSettingsButton)),
      exitButtonSprite(ResourceManager::getTexture(TextureType::MenuExitButton))
{
}
...
void mainMenu::load()
{
    backgroundSprite.setScale(sf::Vector2f(
        1.f * LOGICAL_WIDTH / static_cast<float>(ResourceManager::getTexture(TextureType::MenuBackground).getSize().x),
        1.f * LOGICAL_HEIGHT / static_cast<float>(ResourceManager::getTexture(TextureType::MenuBackground).getSize().y)));

    startButtonSprite.setScale(sf::Vector2f(
        1.f * LOGICAL_WIDTH / ResourceManager::getTexture(TextureType::MenuStartButton).getSize().x / 4.f,
        1.f * LOGICAL_WIDTH / ResourceManager::getTexture(TextureType::MenuStartButton).getSize().x / 4.f));
    startButtonSprite.setOrigin(sf::Vector2f(
        ResourceManager::getTexture(TextureType::MenuStartButton).getSize().x / 2.f,
        ResourceManager::getTexture(TextureType::MenuStartButton).getSize().y / 2.f));
    ...
    exitButtonSprite.setScale(sf::Vector2f(
        1.f * LOGICAL_WIDTH / ResourceManager::getTexture(TextureType::MenuExitButton).getSize().x / 4.f,
        1.f * LOGICAL_WIDTH / ResourceManager::getTexture(TextureType::MenuExitButton).getSize().x / 4.f));
    exitButtonSprite.setOrigin(sf::Vector2f(
        ResourceManager::getTexture(TextureType::MenuExitButton).getSize().x / 2.f,
        ResourceManager::getTexture(TextureType::MenuExitButton).getSize().y / 2.f));
