...
{
    virtual bool checkLineOfSight(const sf::Vector2f &, const std::vector<std::unique_ptr<Object>> &) const;
    ...
    sf::Vector2f nextPathPoint(const sf::Vector2i &, const sf::Vector2i &, const int [GRID_SIZE_X][GRID_SIZE_Y]);
